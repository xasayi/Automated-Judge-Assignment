...
This repository contains code for the paper [Who is a Better Matchmaker? Human vs. Algorithmic Judge Assignment in a High-Stakes Startup Competition](https://arxiv.org/pdf/2510.12692) by Yang (Sarina) Xi, Orelia Pi, Miaomiao Zhang, Rebecca Xiong, Jacqueline Ng Lane, and Nihar B. Shah, The structure of the directory is as follows:
